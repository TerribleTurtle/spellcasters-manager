...
import { schemaToFields, UNIT_FIELD_CONFIG } from "@/domain/schemaToFields";
...
const UNIT_FIELDS = schemaToFields(UnitSchema, UNIT_FIELD_CONFIG);


export function UnitEditor({ initialData, filename, mode, onSave, onNavigateToScribe, onDirtyChange, isNew, onDuplicate }: UnitEditorProps) {
  ...
  const [newUnitId] = useState(() => isNew ? crypto.randomUUID() : "");
                ...
                <div className="flex items-center gap-2">
                   ...
                   {!isNew && onDuplicate && (
                       <Button
                           ...
                           disabled={isSaving}
                           title="Duplicate this unit (enters creation mode)"
                       >
